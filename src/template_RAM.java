...
public class template_RAM {
	
	Template t = new Template();
	String requestor,issue;
	
	
	public template_RAM(String requestor,String issue,String inst,String title){
		...
		t.implementor = requestor.toLowerCase();
		...
		t.release_ref = "RAM Implementation Folder: ";
		...
		t.testing_details = "Testing is not required, value added would be limited";
