...
public class template_Emergency {
	
	Template t = new Template();
	String requestor,issue;
	
	
	public template_Emergency(String requestor,String issue,String inst,String title){
		...
		t.testing_details = "Testing is not required, value added is limited";
